...
const BOOK_DIR = path.join(ROOT, "book.cleaned")
...
const SAMPLE_SLUGS = new Set([
  ...
  "074-thunderstorm",
  "116-fragment-116",
  "176-the-inn-of-reason",
  "210-aesthetics-of-discouragement",
  "347-a-letter-not-to-post",
  "434-moonlights",
  "482-advice-to-unhappily-married-women-i",
  "514-sentimental-education",
])
