...
export async function hashValue(value, salt = "book-of-disquiet") {
...
export function getOrCreateAnonId(request) {
  return getCookieValue(request, "book_of_disquiet_anon") || crypto.randomUUID()
}

export function anonCookie(anonId) {
  return [
    `book_of_disquiet_anon=${anonId}`,
    "Path=/",
    "HttpOnly",
    "SameSite=Lax",
    "Max-Age=31536000",
